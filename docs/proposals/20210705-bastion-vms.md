...
With the above information, the `AzureCluster controller` can create an `AzureMachineTemplate` and a `MachineDeployment` and then the creation of VMs should happen automagically.
